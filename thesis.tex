...
\thesissetup{
    ...
    thanks      = {%
        I would like to thank the ParaDiSe laboratory for a welcoming place to work, and everybody who supported me during the writing of this thesis.
    },
    bib         = citations.bib,
...
The actual changes to the prototype implementation are described later in \autoref{ch:rofi-hal}.
