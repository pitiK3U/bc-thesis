...
\subsection[ Addressing LiDAR's Registers ]{ Addressing \TODO{\gls{vl53l1x}}'s Registers } \label{sec:lidar-i2c} 
...
\section[ \TODO{LiDAR Diver} ]{ \TODO{ \acrshort{lidar} Driver Abstraction in \acrshort{roficom} } } \label{sec:lidar-driver}
