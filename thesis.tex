...
\thesissetup{
    ...
    abstract    = {%
      ...
      % Objective
      This thesis aims to enhance the existing firmware solution to \mbox{a production-ready} state by improving the existing firmware of the \acrshort{roficom} and implementing additional features. 
