...
Each module has a single \emph{control unit} that serves as a centralized control over the actions of the module and all the module's components. Control of the motors is accomplished with a UART protocol; whereas in the case of the docks, it is done with SPI protocol. Additionally, the control unit manages charging and power connections.
