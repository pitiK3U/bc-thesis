...
\subsection{grid-aware}

\subsection[ Universal Module ]{ \gls{universal-module} }
\TODO{
    \begin{itemize}
        \item ESP32
        \item SPI
...
\gls{universal-module} \glsdesc{universal-module}. The module is divided into four component: two bodies and two shoes. Each shoe contains three docks and \TODO{one joint}. Whereas the body 
